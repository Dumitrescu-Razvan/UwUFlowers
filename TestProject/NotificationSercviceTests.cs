...
namespace TestProject
{
    ...
    {
        [Fact]
        public void GetNotifications_ReturnsSortedNotifications()
        {
            ...
            // Assert
            Assert.Equal(3, result.Count); // Assuming there are 3 notifications
            Assert.Equal(notifications[1].Timestamp, result[0].Timestamp); // Asserting that the first notification is the latest
